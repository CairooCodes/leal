    ...
    <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
                <div class="">
                    <h3 class="mb-6 text-sm font-semibold uppercase text-color1 text-center">Leal Comunicação<br> & Marketing</h3>
                    <ul class="text-color1 text-center">
                        <li class="mb-4">
                ...
                <div class="">
                    <h3 class="mb-6 text-sm font-semibold text-color1 uppercase text-center">Serviços</h3>
                    <ul class="text-color1 text-center">
                        <li class="mb-4">
                ...
                <div>
                    <h3 class="mb-6 text-sm font-semibold text-color1 uppercase text-center">Mais Informações</h3>
                    <ul class="text-color1 text-center">
                        <li class="mb-4">
                ...
                <div>
                    <h3 class="mb-6 text-sm font-semibold text-color1 uppercase text-center">Legal</h3>
                    <ul class="text-color1 text-center">
                        <li class="mb-4">
