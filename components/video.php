    ...
    <div class="flex justify-center mt-16">
        <blockquote class="instagram-media" data-instgrm-permalink="https://www.instagram.com/reel/CuncO5VN0Ko/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="14" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
            <div style="padding:16px;"> <a href="https://www.instagram.com/reel/CuncO5VN0Ko/?utm_source=ig_embed&amp;utm_campaign=loading" style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;" target="_blank">
                ...
                <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;"><a href="https://www.instagram.com/reel/CuncO5VN0Ko/?utm_source=ig_embed&amp;utm_campaign=loading" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank">Uma publicação compartilhada por Leal Comunicação &amp; Marketing (@lealcomunicacao)</a></p>
            </div>
        </blockquote>
        ...
        <div class="max-w-screen-xl mx-auto lg:px-6 mt-10 mb-10">
            <div class="flex justify-center items-center">
                <h1 class="m-5 font-bold text-3xl text-center text-white">
                    Está afim de ter seu espaço na internet?
                    <br>
                    Fale com a gente!
                </h1>
                <a href="#">
                    <button class="flex items-center my-2 w-full cursor-pointer rounded-md bg-color2 py-3 px-6 font-bold text-color1 text-lg duration-300 ease-in-out hover:bg-color4 hover:text-white">
                        ...
                        <input type="submit" value="Chama a gente!" class="ml-2">
                    </button>
                </a>
            </div>
        </div>
